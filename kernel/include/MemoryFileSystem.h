...
public:
    ...
    /**
        Makes a new directory. Directories don't really exist in the memory
        file system, but files can still be organised according to '/' in their
        name. Therefore, we can have directory entries (with names terminating
        in '/').
