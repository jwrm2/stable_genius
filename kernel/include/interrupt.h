...
/**
    Enable all interrupts not otherwise disabled.
 */
extern "C"
void enable_interrupts();

/**
    Assembly code to load the Interrupt Descriptor Table.

    @param addr Address of the table to load.
    @param size of the table.
 */
extern "C"
void load_idt(uint32_t addr, uint16_t sz);

/**
    The individual interrupt handlers, defined in interrupt.s in assembly.
 */
extern "C" {
